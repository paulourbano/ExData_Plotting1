...
# Plot a scatterplot of global active power measurements in kilowatts
# over the two day period
plot(subsetData$Time, subsetData$Global_active_power/1000, type="o", pch=".", ylab = "Global Active Power (kilowatts)", xlab = "", cex.lab = 0.7)
